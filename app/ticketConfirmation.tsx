      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View style={[styles.successWrap, { transform: [{ scale: scaleAnim }, { translateY: floatY }], opacity: fadeAnim }]}>
          ...
          <View style={styles.successCard}>
            ...
            <View style={styles.iconCircle}>
               <Ionicons name="checkmark-circle" size={50} color="#3DBF87" />
            </View>
          ...
          <View style={styles.ticket}>
            ...
            <View style={styles.routeRow}>
              ...
              <View style={styles.pathIcon}>
                <Ionicons name="chevron-forward-circle" size={32} color="#3DBF87" />
              </View>
            ...
            <View style={styles.ticketStats}>
              {[
                { label: 'COST', value: `₹${cost}`, color: '#FFE8A0' },
                { label: 'CO2 SAVED', value: `${carbonSaved}kg`, color: '#C8EDDA' },
                { label: 'DISTANCE', value: `${distance}km`, color: '#B0DEFF' },
              ].map((s, i) => (
        ...
        <View style={styles.actionRow}>
           <TouchableOpacity style={styles.actionBtnWrap} onPress={handleShare}>
              <View style={[styles.actionBtnShadow, { backgroundColor: '#6BCBA5' }]} />
              <View style={[styles.actionBtn, { backgroundColor: '#3DBF87' }]}>
           ...
           <TouchableOpacity style={styles.actionBtnWrap} onPress={() => router.push('/(tabs)/history')}>
              <View style={[styles.actionBtnShadow, { backgroundColor: '#A090E0' }]} />
              <View style={[styles.actionBtn, { backgroundColor: '#D4C8F5' }]}>
                <View style={styles.actionBtnHighlight} />
                <Feather name="clock" size={20} color="#6040C0" />
                <Text style={[styles.actionBtnText, { color: '#6040C0' }]}>History</Text>
              </View>
           </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  blob1: { width: 300, height: 300, backgroundColor: '#FFE0CC', top: -50, right: -100 },
  ...
  headerTitle: { fontSize: 20, fontWeight: '900', color: '#2D4A30' },

  // Success bubble
  successWrap: { position: 'relative', marginBottom: 28 },
  successShadow: { position: 'absolute', top: 8, left: 8, right: -8, bottom: -8, backgroundColor: '#A8E6CF', borderRadius: 32, opacity: 0.5 },
  successCard: { backgroundColor: '#FFF', borderRadius: 32, padding: 20, alignItems: 'center', overflow: 'hidden' },
  ...
  iconCircle: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#E8F8EE', justifyContent: 'center', alignItems: 'center', marginBottom: 10 },
  successText: { fontSize: 28, fontWeight: '900', color: '#2D8A5F' },
  successSub: { fontSize: 13, fontWeight: '700', color: '#6B9A80' },

  // Ticket
  ticketWrap: { position: 'relative', marginBottom: 28 },
  ticketShadow: { position: 'absolute', top: 10, left: 10, right: -10, bottom: -10, backgroundColor: '#B0DEFF', borderRadius: 32, opacity: 0.6 },
  ticket: { backgroundColor: '#FFF', borderRadius: 32, padding: 24, overflow: 'hidden' },
  ...
  ticketBrand: { fontSize: 22, fontWeight: '900', color: '#3DBF87' },
  ticketType: { fontSize: 12, fontWeight: '700', color: '#8AB8A0' },
  modePillWrap: { position: 'relative' },
  modePillShadow: { position: 'absolute', top: 3, left: 3, right: -3, bottom: -3, backgroundColor: '#6BCBA5', borderRadius: 12, opacity: 0.5 },
  modePill: { backgroundColor: '#3DBF87', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
  modeText: { fontSize: 11, fontWeight: '900', color: '#FFF' },

  ticketDivider: { height: 2, backgroundColor: '#F0FAFF', marginVertical: 16, borderRadius: 1 },
  
  routeRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 20 },
  cityCol: { flex: 1 },
  cityLabel: { fontSize: 10, fontWeight: '800', color: '#8AB8A0', marginBottom: 4 },
  cityName: { fontSize: 18, fontWeight: '900', color: '#2D4A30' },
  ...
  statLabel: { fontSize: 9, fontWeight: '800', color: '#5A7A60', marginBottom: 4 },
  statValue: { fontSize: 13, fontWeight: '900', color: '#2D4A30' },

  ticketFooter: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 16 },
  footerLabel: { fontSize: 9, fontWeight: '800', color: '#8AB8A0' },
  footerVal: { fontSize: 14, fontWeight: '900', color: '#2D4A30' },

  cutLine: { height: 1, backgroundColor: '#E8F4FF', borderStyle: 'dotted', borderWidth: 1, marginVertical: 20, borderRadius: 1 },
  barcodePlaceholder: { height: 40, width: '100%', backgroundColor: '#F8FBFF', borderRadius: 8, opacity: 0.5 },
  ...
  homeBtnShadow: { position: 'absolute', top: 6, left: 6, right: -6, bottom: -6, backgroundColor: '#6BCBA5', borderRadius: 22, opacity: 0.6 },
  homeBtn: { backgroundColor: '#3DBF87', paddingVertical: 20, alignItems: 'center', borderRadius: 22, overflow: 'hidden' },
  ...
  homeBtnText: { color: '#FFF', fontSize: 18, fontWeight: '900', letterSpacing: 0.5 },
});
